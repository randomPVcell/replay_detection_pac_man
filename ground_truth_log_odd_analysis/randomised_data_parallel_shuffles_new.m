function shuffled_track = randomised_data_parallel_shuffles_new(shuffle_choice,analysis_type,dataset_type,num_shuffles,decoded_replay_events,place_fields_BAYESIAN,BAYSESIAN_NORMALIZED_ACROSS_TRACKS,suffix)
...
parfor i=1:number_of_loops
    out{i}.shuffled_track=randomised_data_run_shuffles(shuffle_choice,analysis_type,dataset_type,new_num_shuffles,decoded_replay_events,place_fields_BAYESIAN,BAYSESIAN_NORMALIZED_ACROSS_TRACKS,suffix);
end
